...
--
-- Name: respusuarios; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.respusuarios (
    id bigint NOT NULL,
...
--
-- Name: respusuarios_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.respusuarios_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: respusuarios_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.respusuarios_id_seq OWNED BY public.respusuarios.id;
...
--
-- Name: respusuarios id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.respusuarios ALTER COLUMN id SET DEFAULT nextval('public.respusuarios_id_seq'::regclass);
...
--
-- Name: respusuarios respusuarios_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.respusuarios
    ADD CONSTRAINT respusuarios_pkey PRIMARY KEY (id);
